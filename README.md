...
This repository is under [Apache-2.0 with a Proof-of-Usage Condition](LICENSE) — the Apache-2.0 licence with one added condition.
Every Apache-2.0 permission is unchanged; the condition below is the only addition, and it asks for
...
| **Provenance Hash** | `SHA-256("System:Operator:ISODate:https://github.com/neonbjb/tortoise-tts")` |
