...
This repository is under Apache-2.0 with a Proof-of-Usage Condition - the
Apache-2.0 licence word for word, plus one added condition, in two halves. It costs nothing to satisfy: it asks for disclosure, not for restraint.
...
https://github.com/neonbjb/tortoise-tts, adding one row to PROOF_OF_USAGE.md:
